...
Vector Vector::operator+(const float& rhs) const { return {x + rhs, y + rhs, z + rhs}; }
...
Vector Vector::operator+(const Vector& rhs) const { return {x + rhs.x, y + rhs.y, z + rhs.z}; }
...
float Vector::dot(const Vector& rhs) const { return x * rhs.x + y * rhs.y + z * rhs.z; }
